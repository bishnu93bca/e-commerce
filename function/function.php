...
//getting the brand
	...
	while ($row_brands = mysqli_fetch_array($run_brands)){ 
		...
		function getCatPro(){
			...
			if($count_cats==0){
				echo "<h2 style='padding:20px;'>No product where found in this category!</h2>";
				exit();
			}
...
function getBrandPro(){
			...
			if($count_brands==0){
				echo "<h2 style='padding:20px;'>No product where found associated to this brands!</h2>";
				exit();
			}
